			...
			$.ajax({
				...
				success : function(response) {
					...
					$(response).find("item").each(function() {
						...
						// weatherExplain[POP]이면 weatherExplain[POP].label => 강수확률
						// || category => weatherExplain[category]가 정의되지 않았다면, 그냥 코드명을 그대로 쓰겠다는 의미
						//  weatherExplain[category]?.interpret(fcstValue) 

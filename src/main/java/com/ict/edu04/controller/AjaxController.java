...
/*
	@Controller는 주로 ModelAndView를 반환하기 위해 사용
		Dispather Servlet(servlet-context.xml)으로 반환
		
	@RestController는 객체를 브라우저에 그대로 반환
		Dspather Servlet(servlet-context.xml) 가지 않는다.
		보통 ajax에서 사용
*/
...
public class AjaxController {
	...
	private String fetchWeather(String dataType) {
		...
		try {
			...
			String serviceKey="23LQgtg2CVt0xpwGRt4sVRTdgl2/FNzUstnPz+O5gpBf/Pg/I/LIKJktbYr6ZeUS2gA8w0XpO2Y8YfX0536rVA==";

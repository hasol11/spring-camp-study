...
<body>
	...
	<table>
		...
		<tr>
			<td width="30%">제품가격</td>
			<td width="70%">정가 : <fmt:formatNumber value="${svo.p_price}" pattern="#,##0"/>원 <br>
			<span style="color:red;">(할인가:<fmt:formatNumber value="${svo.p_saleprice}" pattern="#,##0"/>)</span></td>
		</tr>
		<tr>
			<td>제품설명</td>
			<td>${svo.p_content}</td>
		...
		<tr>
			<td colspan="2" align="center"><img src='<c:url value="resources/images/${svo.p_image_s}" />'width="450px"></td>
		</tr>
		<tr>
			<td colspan="2"></td>
		</tr>
